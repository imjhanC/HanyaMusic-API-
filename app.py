from fastapi import FastAPI, HTTPException, Query, BackgroundTasks, Request, File, UploadFile, Form, Depends
...
if __name__ == "__main__":
    ...
    print("🔐 Auth endpoints: /auth/register, /auth/token, /auth/users/me")
...
# Auth:          /auth/register, /auth/token, /auth/users/me
# Stats:         /stats
